...
bodies, resolution notes, and validation records for archived one-off work
remain in `v0.2.43` and `v0.2.60`.
...
- [!] [B077] (P1) Publish and activate the merged LLM Proxy contract.
  Goal:
...
- [ ] [I216] (P1) Make one model-operation capability and pricing catalog authoritative.
  Goal:
...
- [!] [I039] (P1) Replace or retire the backend-ineligible Qwen Cloud Token Plan provider.
  Goal:
...
- [ ] [I041] (P2) Migrate Grok to xAI Responses without OpenAI background assumptions.
  Goal:
...
- [ ] [M001R] (P2) Backlog hygiene and archive.
  ...
  validation records at `v0.2.60`. Reopened stale taken status B099 because the
  legacy `llm-proxy` Compose service remains declared in
  `docker-compose.local.yml`, and removed satisfied archived dependencies from
  B077, I216, I045, I038, I039, I207, I041, I035, I032, I027, M013, P006,
  P001, P003, P004, and P005. All active, blocked, recurring, and Planning
  entries remain in this tracker. No follow-up issues were filed.
...
- [ ] [P006] (P1) Define provider lifecycle, model onboarding, and hosted service SLA terms.
  Goal:
...
- [ ] [P001] (P1) Design a tenant-scoped provider, model, and key-acquisition onboarding flow.
  ...
  - Run the required baseline and final `timeout -k 350s -s SIGKILL 350s make ci`
    pair for the implementation, with the final run after the last code edit.
- [ ] [P003] (P1) Re-audit and expand the SEO/use-case resource system from verified product contracts.
  Goal:
  ...
  - Run the required baseline and final `timeout -k 350s -s SIGKILL 350s make ci`
    pair for the implementation, with the final run after the last code edit.
- [x] [P004] (P1) {P003} Make Resources an always-available footer surface and enforce the resource-page shell.
  Goal:
...
- [x] [P005] (P1) {P004} Normalize public Privacy and Terms pages using PoodleScanner's legal-page contract as the structural reference.
  Goal:
