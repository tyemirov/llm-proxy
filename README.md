...
| `make ci-backend` | Run release checks, Go and Python analysis, protocol acceptance, admission race tests, Go coverage tests, Python tests, and local provider preflight. |
