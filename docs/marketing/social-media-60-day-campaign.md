...
| 41 | 2026-08-15 | AM | Native Gemini requests must not force a Gemini-specific client in every app. LLM Proxy maps shared messages into stored Gemini 3.x Interactions and owns the poll, cancel, and delete lifecycle. |
