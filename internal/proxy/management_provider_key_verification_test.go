...
func TestManagementProviderKeyVerificationUsesEveryCanonicalTransportBeforePersistence(t *testing.T) {
	transportCases := []providerKeyVerificationTransportCase{
		...
		{provider: proxy.ProviderNameMiniMax, model: proxy.ModelNameMiniMaxM25, providerModel: "MiniMax-M2.5", transport: verificationTransportChat, tokenLimitField: "max_completion_tokens"},
		{provider: proxy.ProviderNameMiniMax, model: proxy.ModelNameMiniMaxM25HighSpeed, providerModel: "MiniMax-M2.5-highspeed", transport: verificationTransportChat, tokenLimitField: "max_completion_tokens"},
		{provider: proxy.ProviderNameMiniMax, model: proxy.ModelNameMiniMaxM21, providerModel: "MiniMax-M2.1", transport: verificationTransportChat, tokenLimitField: "max_completion_tokens"},
		{provider: proxy.ProviderNameMiniMax, model: proxy.ModelNameMiniMaxM21HighSpeed, providerModel: "MiniMax-M2.1-highspeed", transport: verificationTransportChat, tokenLimitField: "max_completion_tokens"},
