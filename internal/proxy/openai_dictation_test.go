...
func TestTranscribeAudioWithURLReturnsReaderError(t *testing.T) {
	...
	_, transcriptionError := client.transcribeAudioWithURL(context.Background(), "key", "http://example.test", keyModel, DefaultTranscriptionModel, "audio.webm", transcriptionFailingReader{}, nil)
