...
export const COPY = Object.freeze({
  ...
  closeSettings: "Close",
  settingsRequiresClientAndProviderKey: "Create a client key and save at least one provider API key before leaving Settings.",
  settingsRequiresClientKey: "Create a client key before leaving Settings.",
  settingsRequiresProviderKey: "Save at least one provider API key before leaving Settings.",
  clientKey: "Key",
  clientKeyMissing: "No key created",
  clientKeyRetained: "Key retained — create a replacement to copy a new value",
